...
describe "download_permissions/edit" do
  before(:each) do
  ...
  it "renders the edit download_permission form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => download_permissions_path(@download_permission), :method => "post" do
